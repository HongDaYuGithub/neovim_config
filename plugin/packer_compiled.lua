...
_G.packer_plugins = {
  ...
  ["alpha-nvim-fortune"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/alpha-nvim-fortune",
  ...
  ["nvim-cursorline"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-cursorline",
  ...
  ["nvim-lsp-smag"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-lsp-smag",
  ...
  ["nvim-treesitter-pairs"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-treesitter-pairs",
  ...
  ["tabline.nvim"] = {
    ...
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/tabline.nvim",
  ...
  ["virtual-types.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/virtual-types.nvim",
